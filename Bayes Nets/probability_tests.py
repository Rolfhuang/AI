...
class ProbabilityTests(unittest.TestCase):
    ...
    def test_probability_setup(self):
        ...
        # test H distribution͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        ...
        # test C distribution͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        security_system = set_probability(make_security_system_net())
        ...
        # test M distribution͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        security_system = set_probability(make_security_system_net())
        ...
        # test B distribution͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        security_system = set_probability(make_security_system_net())
        ...
        # Q distribution͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        # can't test exact probabilities because͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        # order of probabilities is not guaranteed͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        ...
        # K distribution͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        ...
        # D distribution͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
    ...
    # Part 2a Test͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
    def test_games_network(self):
        ...
        # Now testing that all nodes in the games network have proper probability distributions.͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        # Note that all nodes have to be named predictably for tests to run correctly.͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀

        # First testing team distributions.͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        # You can check this for all teams i.e. A,B,C (by replacing the first line for 'B','C')͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        ...
        # Now testing match distributions.͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        # You can check this for all matches i.e. AvB,BvC,CvA (by replacing the first line)͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
    ...
    # Part 2b Test͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
...
def Gibbs_Test(g_net,in_state):
    gibbs_f=Gibbs_sampler(g_net,in_state)
    print(gibbs_f)

def MH_Test(g_net,in_state):
    mh=MH_sampler(g_net,in_state)
    print(mh)

def compare_Test(g_net,in_state):
    mh=compare_sampling(g_net,in_state)
    # print(mh[0][0]+mh[0][1]+mh[0][2])
    # print(mh[1][0]+mh[1][1]+mh[1][2])
    print(mh)
if __name__ == '__main__':
    # unittest.main()
    g_net=get_game_network()
    # make_net=set_probability(g_net)
    # print(get_marginal_double0(make_net))
    in_state=[2,1,2,0,0,2]
    compare_Test(g_net,in_state)
    # sampling_question()
    # # in_state=[]
    # # Gibbs_Test(g_net,in_state)
    # MH_Test(g_net,in_state)
