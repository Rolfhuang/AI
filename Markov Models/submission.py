...
def part_2_a():
    ...
    a_transition_probs = {
        ...
        'A2': {'A3': (0., 0.), 'A2': (0., 0.), 'A1': (0., 0.), 'Aend': (0., 0.)},
        'A3': {'A1': (0., 0.), 'A3': (0., 0.), 'A2': (0., 0.), 'Aend': (0., 0.)},
        'Aend': {'A3': (0., 0.), 'A2': (0., 0.), 'A1': (0., 0.), 'Aend': (0., 0.)}
    }
    # example: {'A1': [(right-hand-mean, right-hand-std), (right-thumb-mean, right-thumb-std)] ...}͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
    a_emission_paras = {
    ...
    n_transition_probs = {
        ...
        'N2': {'N2': (0., 0.), 'N1': (0., 0.), 'N3': (0., 0.), 'Nend': (0., 0.)},
        'N3': {'N1': (0., 0.), 'N2': (0., 0.), 'N3': (0., 0.), 'Nend': (0., 0.)},
        'Nend': {'N1': (0., 0.), 'N3': (0., 0.), 'N2': (0., 0.), 'Nend': (0., 0.)}
    }
    n_emission_paras = {
