#!/usr/bin/env python͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
import traceback
from isolation import Board, game_as_text
from test_players import RandomPlayer, HumanPlayer, Player, MiniMaxPlayer
import platform
...
def correctOpenEvalFn(yourOpenEvalFn):
    ...
    try:
        ...
        # setting up the board as though we've been playing͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        board_state = [
            ['Q1', 'X', ' ', ' ', ' ', ' ', ' ', ' ', ' '],
            ['X', 'X', 'X', ' ', ' ', ' ', ' ', 'X', ' '],
            [' ', 'X', ' ', ' ', ' ', ' ', ' ', 'X', ' '],
        ...
        #test = sample_board.get_legal_moves()͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        h = yourOpenEvalFn()
...
def beatRandom(yourAgent):
    ...
    try:
        ...
        # Uncomment to see game͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        print(game_as_text(winner, move_history, termination, output_b))
        # ͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏
    except NotImplementedError:
...
def minimaxTest(yourAgent, minimax_fn):
    ...
    # create dummy 9x9 board͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
    ...
    try:
        ...
        # sample_board = Board(player, MiniMaxPlayer())
        # setting up the board as though we've been playing͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        board_state = [
            [" ", "X", "X", " ", "X", "X", " ", "X", " "],
            [" ", " ", "X", " ", " ", "X", " ", " ", "X"],
        ...
        if test_pass:
            ...
            # sample_board = Board(MiniMaxPlayer(),player)
            # setting up the board as though we've been playing͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
            board_state = [
                [" ", " ", " ", " ", "X", " ", "X", " ", "X"],
                ["X", "X", "X", " ", "X", "Q2", " ", "X", "X"],
