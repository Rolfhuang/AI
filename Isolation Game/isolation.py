...
import time
import platform
# import io͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
from io import StringIO

# import resource͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
...
class Board:
    ...
    def set_state(self, board_state, p1_turn=True):
        ...
        if last_move_q1 != []:
            # set last move to the first found occurance of 'Q1'͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        ...
        # Count X's to get move count + 2 for initial moves͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        self.move_count = sum(row.count('X') + row.count('Q1') + row.count('Q2') for row in board_state)

    #function to edit to introduce any variant - edited for impact crater variant by Matthew Zhou (1/23/2023)͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
    def __apply_move__(self, queen_move):
        ...
        '''
        # print("Applying move:: ", queen_move)͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        col, row = queen_move
        my_pos = self.__last_queen_move__[self.__active_players_queen__]
        #opponent_pos = self.__last_queen_move__[self.__inactive_players_queen__]͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀

        ######Change the following lines to introduce any variant######͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        if my_pos != Board.NOT_MOVED:
            self.__board_state__[my_pos[0]][my_pos[1]] = Board.BLOCKED
        
            #check if queen moves more than 1 space in any direction͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
            if abs(col - my_pos[0]) > 1 or abs(row - my_pos[1]) > 1:
                self.__create_crater__(queen_move)
       ######Change above lines to introduce any variant######͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        
        # apply move of active player͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        ...
        # increment move count͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        self.move_count = self.move_count + 1

        # If opponent is isolated͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
        if not self.get_active_moves():
            return True, self.__inactive_players_queen__

        return False, None

    #function for impact crater variant only͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
    ...
    def __get_moves__(self, move):
        ...
        for direction in directions:
            for dist in range(1, max(self.height, self.width)):
                ...
                # Allow for wrapping moves to other side of the board͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
    ...
    def play_isolation(self, time_limit=10000, print_moves=False):
        ...
        while True:
            ...
            def time_left():
                # print("Limit: "+str(time_limit) +" - "+str(curr_time_millis()-move_start))͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
            ...
            if is_over:
                ...
                # if not self.get_active_moves():͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
                #     return self.__active_players_queen__, move_history, \͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
                #            (self.__inactive_players_queen__ + " has no legal moves left.")͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
                # return self.__active_players_queen__, move_history, \͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
                #        (self.__inactive_players_queen__ + " was forced off the grid.")͏︆͏󠄃͏󠄌͏󠄍͏︅͏︀͏︋͏︋͏󠄄͏︁͏︀
